...
{
    public abstract class NeighborhoodWatchWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static NeighborhoodWatchWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(NeighborhoodWatchWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<NeighborhoodWatchDbContext> action)
        {
            using (var context = IocManager.Resolve<NeighborhoodWatchDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<NeighborhoodWatchDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<NeighborhoodWatchDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<NeighborhoodWatchDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<NeighborhoodWatchDbContext, Task<T>> func)
        {
            T result;
