...
namespace NeighborhoodWatch.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = NeighborhoodWatchConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(NeighborhoodWatchDbContext context)
        {
            _context = context;
        }
