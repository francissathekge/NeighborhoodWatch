...
namespace NeighborhoodWatch.Migrations
{
    ...
    [Migration("20230623094022_202306221916")]
    partial class _202306221916
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieListAbpApp.Domain.Person", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NeighborhoodWatch.Domain.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NeighborhoodWatch.Domain.Donation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NeighborhoodWatch.Domain.PatrollingRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NeighborhoodWatch.Domain.Reward", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NeighborhoodWatch.Domain.SecurityCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("NunberOFAvailableGuards")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("NeighborhoodWatch.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("NeighborhoodWatch.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MovieListAbpApp.Domain.Person", b =>
                {
                    b.HasOne("NeighborhoodWatch.Domain.Address", "Address")
                        .WithMany()
                        .HasForeignKey("AddressId");

                    b.HasOne("NeighborhoodWatch.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
